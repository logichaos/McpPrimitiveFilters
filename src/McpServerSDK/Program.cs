...
.AddJwtBearer(options =>
{
    ...
    // For local development with a self-signed dev certificate on the OAuth server,
    // disable SSL validation on the backchannel. Remove this in production!
